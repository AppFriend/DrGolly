                ...
                <div key={order.id} className="flex items-center justify-between p-3 sm:p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-xs sm:text-sm text-gray-600 truncate">{order.customerName}</div>
                      <div className="text-xs text-gray-500 truncate">{order.courseTitle}</div>
                    </div>
                  </div>
                  <div className="text-right flex-shrink-0 ml-2">
                    <div className="font-semibold text-sm sm:text-base">{formatCurrency(order.amount)}</div>
                    <div className="text-xs sm:text-sm text-gray-500">{formatDate(order.purchasedAt)}</div>
