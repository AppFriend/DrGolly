    ...
    >
      <div className="relative">
        <img
          ...
          onLoad={() => {
            console.log('Image loaded successfully:', course.thumbnailUrl || course.thumbnail_url, 'for course:', course.title);
          }}
          onError={(e) => {
            const target = e.target as HTMLImageElement;
            console.log('Image failed to load:', target.src, 'for course:', course.title);
